...
out = subprocess.getoutput("powershell -Terminal \"& {Get-PnpDevice | Select-Object Status,Class,FriendlyName| ConvertTo-Json}\"")
...
e1=Label(root, text="Name", font=('Helvatika',10,'bold'))
